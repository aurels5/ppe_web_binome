...
INSERT INTO `eleve` (`u_code`, `pr_code`, `el_redoublant`, `el_date_naissance`, `el_sexe`, `el_diplome_prec`, `el_international`, `el_option`) VALUES
(4, 2, NULL, '1995-03-09', 1, 'Bac+2 Photo', NULL, 'SLAM'),
(5, 2, NULL, '1995-10-18', 0, 'Bac Pro SEN', NULL, 'SLAM'),
(6, 1, 1, '1998-10-10', 1, 'Bac', NULL, 'SISR'),
(7, 1, NULL, '1998-10-18', 0, 'Bac', NULL, 'SLAM'),
(8, 1, NULL, '1997-10-01', 0, 'Bac', NULL, 'SLAM'),
(9, 1, 1, '1997-05-05', 0, 'Bac STMG', NULL, 'SLAM'),
(10, 2, NULL, '1998-11-06', 1, 'Bac STMG', NULL, 'SLAM'),
(11, 2, NULL, '1998-12-14', 1, 'Bac ES', NULL, 'SLAM'),
(12, 2, NULL, '1998-10-10', 0, 'Bac STI2D', NULL, 'SISR'),
(13, 2, NULL, '2017-10-16', 0, 'Bac Pro SEN', NULL, 'SISR'),
(14, 2, NULL, '1997-10-11', 0, 'Bac Pro SEN', NULL, 'SISR'),
(15, 2, NULL, '1997-10-23', 0, 'Bac STMG', NULL, 'SISR');
...
--
ALTER TABLE `users`
  MODIFY `u_code` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
